...
namespace AddressBook.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Address1,Address2,City,State,Zip,Email,Phone,ImageData,ImageType,Created,ImageFile")] Contact contact)
        {
